    ...
    <nav className="side-mobile-menu">
      ...
      <ul id="mobile-menu-active">
        <li>
         ...
         <li>
          <a href="3team" className="scrollspy-btn" >Team</a>
        </li>
         <li>
          <a href="#!" className="scrollspy-btn">Blog</a>
        </li>
         <li>
          <a href="#!" className="scrollspy-btn">Get in touch</a>
        </li>
      </ul>
    </nav>
